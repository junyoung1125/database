...
CREATE TABLE`bank_customer` (
    ...
    `c_phone`	CHAR(20) Not null  unique key,
...
insert into `bank_customer` values ('941127','이순신',1,'010-1234-1006','부산시 영도구');
...
#실습2-10(모름)
select * from `bank_account` where '자유저축예금' AND a_balance >= 1000000 ;
#실습2-11(모름)
